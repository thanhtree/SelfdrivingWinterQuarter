...
"""autogenerated by genpy from data_collection/ServiceRequest.msg. Do not edit."""
import sys
...
class ServiceRequest(genpy.Message):
  ...
  _type = "data_collection/ServiceRequest"
...
def _get_struct_q():
    ...
    return _struct_q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from data_collection/ServiceResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ServiceResponse(genpy.Message):
  ...
  _type = "data_collection/ServiceResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
