...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name data_collection-msg:<Message> is deprecated: use data_collection-msg:Message instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader data_collection-msg:num-val is deprecated.  Use data_collection-msg:num instead.")
  (num m))
