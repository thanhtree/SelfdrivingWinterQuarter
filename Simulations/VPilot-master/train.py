...
if __name__ == '__main__':
	...
	datasetFiles = ['G:\GTAVDataset\dataset.txt']
	...
	model = aitorNet.getModel(weights_path="model.hdf5")
	model.compile(optimizer=RMSprop(), loss='mse')
	#ckp_callback = ModelCheckpoint("model.h5", monitor="val_loss", save_best_only=True, save_weights_only=True, mode='min')
	ckp_callback = ModelCheckpoint("model.hdf5", monitor="val_loss", save_best_only=True, save_weights_only=True, mode='min')
